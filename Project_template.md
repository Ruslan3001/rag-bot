...
- **Статистика индекса:** Из 35 файлов сгенерировано 868 логических чанков.
...
### Примеры работы бота (Скриншоты заменяют логи)
...
> **Вы:** В каком году открылась трамвайная сеть Веги?
> **Бот:**
> 1. Ищу в контексте информацию о дате открытия "Трамвайной сети Веги".
> 2. В документе "Трамвайная сеть Веги" указано, что первая очередь линии введена в эксплуатацию 5 ноября 1984 года.
> 3. Следовательно, ответ — 5 ноября 1984 года.
...
> 2. В предоставленных документах базы знаний нет никакой информации о паролях.
